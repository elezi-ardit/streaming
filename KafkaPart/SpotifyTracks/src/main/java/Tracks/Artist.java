...
public class Artist extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1728702527836909071L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Artist\",\"namespace\":\"Tracks\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"}]}");
   ...
   */
  public Artist(java.lang.CharSequence name) {
    this.name = name;
  }
   ...
   */
  public static Tracks.Artist.Builder newBuilder() {
    return new Tracks.Artist.Builder();
  }
   ...
   * @return A new Artist RecordBuilder
   */
  public static Tracks.Artist.Builder newBuilder(Tracks.Artist.Builder other) {
    if (other == null) {
      return new Tracks.Artist.Builder();
    } else {
      return new Tracks.Artist.Builder(other);
    }
  }
   ...
   * @return A new Artist RecordBuilder
   */
  public static Tracks.Artist.Builder newBuilder(Tracks.Artist other) {
    if (other == null) {
      return new Tracks.Artist.Builder();
    } else {
      return new Tracks.Artist.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Artist>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Tracks.Artist.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Tracks.Artist other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public Tracks.Artist.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Tracks.Artist.Builder clearName() {
      name = null;
