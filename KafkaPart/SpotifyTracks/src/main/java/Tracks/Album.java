...
public class Album extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Album(java.lang.CharSequence name) {
    this.name = name;
  }
   ...
   */
  public static Tracks.Album.Builder newBuilder() {
    return new Tracks.Album.Builder();
  }
   ...
   * @return A new Album RecordBuilder
   */
  public static Tracks.Album.Builder newBuilder(Tracks.Album.Builder other) {
    if (other == null) {
      return new Tracks.Album.Builder();
    } else {
      return new Tracks.Album.Builder(other);
    }
  }
   ...
   * @return A new Album RecordBuilder
   */
  public static Tracks.Album.Builder newBuilder(Tracks.Album other) {
    if (other == null) {
      return new Tracks.Album.Builder();
    } else {
      return new Tracks.Album.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Album>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Tracks.Album.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Tracks.Album other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public Tracks.Album.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Tracks.Album.Builder clearName() {
      name = null;
